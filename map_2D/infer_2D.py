...
# Training map
gt = get_ground_truth_array(r'C:\Users\USER\IdeaProjects\PEDRA_CPU\map_2D\environments\filled_simple_floorplan_v2.png')
# plt.imshow(gt, 'Greys_r')
# plt.show()

# Paths
custom_load_dir = 'C:/Users/USER/IdeaProjects/PEDRA_CPU/map_2D/results/weights/drone_2D_10000'
...
# agent
drone = agent2D.agent_2D(BHM=BHM, min_max=min_max, LIDAR_pixel_range=LIDAR_max_range, ground_truth_map=gt, starting_pos=valid_starting_points[3],
